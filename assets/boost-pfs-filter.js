...
(function() {
  ...
  Filter.prototype.afterRender = function(data, eventType) {
    ...
    if (Utils.isMobile()) {
      jQ('.h2.drawer__title').text('').addClass('boost-custom-logo').css('background', 'url(https://cdn.shopify.com/s/files/1/0508/8598/4464/files/Positive_Logo.png?v=1676489392)');
      jQ('button.boost-pfs-filter-show-result')[0].on('click', function() {
        jQ('button.drawer__close-button.js-drawer-close').trigger('click');
      })
    }
